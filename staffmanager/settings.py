...
SECRET_KEY = 'iezfihe4rufni)t_je&bg-=0a#zaru51c#+_z+6qqxwpfs++p%'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['10.0.0.174', 'localhost', '127.0.0.1']
...
# Need to change this to use my local postgres server
